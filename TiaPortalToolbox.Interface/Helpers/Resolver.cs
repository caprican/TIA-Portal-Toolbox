...
public static class Resolver
{
    ...
    public static Assembly? OnResolve(object? sender, ResolveEventArgs args)
    {
        ...
        if (assemblyName.Name.Equals(SiemensEngineeringAssemblyName))
        {
            path = assemblyPath;
        }
    ...
    /// </summary>
    /// <returns></returns>
    public static IReadOnlyList<Models.OpennessVersion> GetOpennessLibraries()
    {
        var opennessVersions = new List<Models.OpennessVersion>();
