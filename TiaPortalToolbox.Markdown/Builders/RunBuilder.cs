...
{
    private Markdig.Syntax.Block md;
    ...
    public RunBuilder(Markdig.Syntax.Block md, Paragraph para)
    {
        this.para = para;
        this.md = md;

        //Italic = new PatternMatcher(PatternMatcher.Pattern.Grave);
        //Italic.FindMatches(md, ref Tokens);

        //Bold = new PatternMatcher(PatternMatcher.Pattern.DblAsterisk);
        //Bold.FindMatches(md, ref Tokens);

        //if (MarkdownService.ExtendedMode)
        //{
