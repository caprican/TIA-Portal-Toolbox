...
public static class Resolver
{
    ...
    /// </summary>
    /// <returns></returns>
    public static IReadOnlyList<TiaPortalToolbox.Core.Models.OpennessVersion> GetOpennessLibraries()
    {
        var opennessVersions = new List<TiaPortalToolbox.Core.Models.OpennessVersion>();
                    ...
                    if (publicApis != null)
                    {
                        foreach (var publicApiVersion in publicApis)
                        {
                            ...
                            if (!string.IsNullOrWhiteSpace(library) && File.Exists(library))
                            {
                                ...
                                var opennessVersion = new TiaPortalToolbox.Core.Models.OpennessVersion(portalVersion, library, apiVersion);
